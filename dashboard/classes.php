...
<head>
    ...
    <title>Classes - Dasboard Superstar Fitness</title>
...
<body class="d-flex">
    ...
    <div class="container" style="margin-left:150px">
        <div class="my-5">
            ...
            <h1><b>ALL CLASSES</b></h1>
            <p class="text-body-secondary">This feature is used to display, add, delete and update all classes that
                available at Superstar Fitness.</p>
            ...
            <div class="modal fade" id="addClass" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
                ...
                <div class="modal-dialog modal-dialog-centered ">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h1 class="modal-title fs-5" id="addClassesLabel<?= $data['id'] ?>">Add New Class</h1>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <form method="POST" action="addClasses.php">
                            <div class="modal-body">
                                <div class="mb-3">
                                    <div class="row g-2">
            ...
            <div class="container px-4 py-2" style="background-color: white; border-radius: 10px;">
                <table class="table table-striped table-hover display data">
                    ...
                    <tbody>
                        <?php
                        include ("connect.php");
                        $sql1 = "select id, name, type, coach, date_format(date, '%W, %d %M %Y') as formatdate, time_format(time, '%H:%i') as formattime, complexity, intensity, duration, description from classes order by id asc";
                    ...
                    ?>
                        <tr>
                            ...
                            <td style="vertical-align: middle;"><?= ucfirst($data['type']) ?></td>
                            ...
                            <td style="vertical-align: middle; text-align: center;">
                                <a href="editClasses.php?id=<?= $data['id'] ?>" type="button" class="btn btn-warning"
                                    data-bs-toggle="modal" data-bs-target="#editClasses<?= $data['id'] ?>">
                                    <i class="fa fa-pencil-square-o" style="font-size: 30px;"></i>
                                </a>
                                <a href="deleteClasses.php?id=<?= $data['id'] ?>" type="button" class="btn btn-danger"
